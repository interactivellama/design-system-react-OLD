define(['module', 'react', 'react-dom', 'classnames', '../../utilities/constants', '../utilities/dialog', '../../utilities/dialog-helpers', './check-props', 'lodash.flatten', 'lodash.compact', 'shortid'], function (module, _react, _reactDom, _classnames, _constants, _dialog, _dialogHelpers, _checkProps, _lodash, _lodash3, _shortid) {
	'use strict';
