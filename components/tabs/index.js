define(['module', 'react', 'prop-types', 'react-dom', 'shortid', 'classnames', 'lodash.isfunction', 'lodash.isnumber', './private/tabs-list', './private/tab', './private/tab-panel', '../../utilities/constants', '../../utilities/key-code', '../../utilities/event'], function (module, _react, _propTypes, _reactDom, _shortid, _classnames, _lodash, _lodash3, _tabsList, _tab3, _tabPanel, _constants, _keyCode, _event) {
	'use strict';
				...
				return (
					...
					_react2.default.createElement(
						...
						children.map(function (child, index) {
							...
							var selected = _this2.getSelectedIndex() === index;
							var focus = selected && _this2.state.focus;
