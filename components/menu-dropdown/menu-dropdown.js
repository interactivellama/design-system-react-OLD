define(['module', 'react', 'react-dom', 'classnames', 'lodash.isboolean', 'lodash.isfunction', 'shortid', '../utilities/dialog', '../utilities/menu-list', '../utilities/menu-list/item', '../utilities/menu-list/item-label', './button-trigger', './check-props', '../../utilities/keyboard-navigable-menu', '../../utilities/EventUtil', '../../utilities/KEYS', '../../utilities/constants'], function (module, _react, _reactDom, _classnames, _lodash, _lodash3, _shortid, _dialog, _menuList, _item, _itemLabel, _buttonTrigger, _checkProps, _keyboardNavigableMenu, _EventUtil, _KEYS, _constants) {
	'use strict';
  ...
  */
   ...
   */
			return _react2.default.createElement(CurrentTrigger, _extends({
				...
				menu: isInline ? this.renderInlineMenu(customContent, isOpen) : this.renderDialog(customContent, isOpen, outsideClickIgnoreClass),
	...
	module.exports.ListItem = _item2.default;
