define(['module', 'react', 'react-dom', 'classnames', 'lodash.isfunction', 'react-onclickoutside', 'shortid', '../popover', '../menu-list/list', '../menu-list/list-item', '../menu-list/list-item-label', './button-trigger', './check-props', '../../utilities/keyboard-navigable', '../../utilities', '../../utilities/constants'], function (module, _react, _reactDom, _classnames, _lodash, _reactOnclickoutside, _shortid, _popover, _list, _listItem, _listItemLabel, _buttonTrigger, _checkProps, _keyboardNavigable, _utilities, _constants) {
	'use strict';
  ...
  */
	var MenuDropdown = (0, _reactOnclickoutside2.default)(_react2.default.createClass({
		// ### Display Name
