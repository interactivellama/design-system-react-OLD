define(['module', 'react', 'react-dom', '../utilities/dialog', './private/date-picker-base/index', '../icon/input-icon', './check-props', '../../utilities/EventUtil', '../../utilities/KEYS', '../../utilities/constants'], function (module, _react, _reactDom, _dialog, _index, _inputIcon, _checkProps, _EventUtil, _KEYS, _constants) {
	'use strict';
   ...
   */
	...
	module.exports = _react2.default.createClass({
		...
		getInitialState: function getInitialState() {
			...
			var initDate = this.props.value ? dateString : this.props.strValue;
			return {
				isOpen: false,
