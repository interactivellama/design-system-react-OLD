define(['module', 'react', 'classnames', 'shortid', '../../icon/input-icon', './check-props', '../../../utilities/constants'], function (module, _react, _classnames, _shortid, _inputIcon, _checkProps, _constants) {
    ...
    */
		...
		render: function render() {
			...
			var props = _objectWithoutProperties(_props, ['assistiveText', 'children', 'className', 'disabled', 'errorText', 'iconLeft', 'iconRight', 'inlineEditTrigger', 'inputRef', 'label', 'onBlur', 'onChange', 'onClick', 'onFocus', 'onInput', 'onInvalid', 'onKeyDown', 'onKeyPress', 'onKeyUp', 'onSelect', 'onSubmit', 'minLength', 'maxLength', 'name', 'placeholder', 'readOnly', 'required', 'role', 'type', 'value']);
