define(['module', 'react', 'react-dom', 'lodash.assign', 'classnames', 'lodash.isboolean', 'lodash.isfunction', './check-props', 'shortid', '../button', '../utilities/dialog', '../../utilities/dialog-helpers', '../../utilities/keyboard-navigable-dialog', '../../utilities/KEYS', '../../utilities/constants'], function (module, _react, _reactDom, _lodash, _classnames, _lodash3, _lodash5, _checkProps, _shortid, _button, _dialog, _dialogHelpers, _keyboardNavigableDialog, _KEYS, _constants) {
	'use strict';
